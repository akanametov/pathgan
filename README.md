...
* [Dataset (generated)](https://github.com/akanametov/pathgan/releases/download/2.0/dataset.zip)
* [MovingAI Dataset](https://github.com/akanametov/pathgan/releases/download/2.0/movingai.zip)
* [Results (ROI's) of Original Generator (from paper)](https://github.com/akanametov/pathgan/releases/download/2.0/results.zip)
* [Results (ROI's) of Pix2Pix Generator (ours)](https://github.com/akanametov/pathgan/releases/download/2.0/pixresults.zip)
* [MovingAI results (ROI's) of Original Generator (from paper)](https://github.com/akanametov/pathgan/releases/download/2.0/movingai_results.zip)
* [MovingAI results (ROI's) of Pix2Pix Generator (ours)](https://github.com/akanametov/pathgan/releases/download/2.0/movingai_pixresults.zip)
* [Collected logs from RRT*](https://github.com/akanametov/pathgan/releases/download/2.0/logs.zip)
